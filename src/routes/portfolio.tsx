...
const projects: Project[] = [
  { name: "Northwind Ops", client: "Northwind Labs", cat: "Automation", year: "2025", sector: "Logistics", metric: "−72%", metricLabel: "manual ops time", hue: "from-slate-700 via-blue-900 to-indigo-950", problem: "Four spreadsheets and a daily standup kept dispatch alive — barely.", approach: "Event-driven workflows wired to the carrier APIs, with a thin internal panel for exceptions only.", result: "Operations team got a week back per month. Zero downtime in six months of running.", tech: ["Temporal", "Postgres", "Sentry", "Cloudflare Workers"] },
  ...
  { name: "Northbound Intake", client: "Northbound", cat: "Automation", year: "2024", sector: "Wellness", metric: "+62%", metricLabel: "intake-to-booking", hue: "from-teal-800 via-cyan-900 to-sky-950", problem: "New patient intake was a 14-day email tag battle.", approach: "Intake automation routing forms to the right clinician, with reminders and pre-call prep packets.", result: "Time-to-first-booking dropped from 14 days to 18 hours.", tech: ["Cloudflare", "Twilio", "Calendly", "Resend"] },
